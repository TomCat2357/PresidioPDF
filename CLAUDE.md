...
├── .claude/               # Claude AI documentation structure
│   ├── 00_project/        # Project requirements and overview
│   ├── 01_development_docs/ # Technical design documents
│   ├── 02_design_system/  # Design system documentation
│   └── 03_library_docs/   # Library strategies and dependencies
...
### 📋 Project Documentation (`.claude/00_project/`)
...
### 🔧 Development Documentation (`.claude/01_development_docs/`)
...
### 🎨 Design System Documentation (`.claude/02_design_system/`)
...
### 📚 Library Integration Documentation (`.claude/03_library_docs/`)
