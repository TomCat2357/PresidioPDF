...
# -*- coding: utf-8 -*-
"""
PDF個人情報マスキングツール - FletによるGUI実装（PDFビューア機能付き）
"""
...
class PresidioPDFApp:
    ...
    def _update_thumbnails(self):
        ...
        for i in range(page_count):
            ...
            # 現在のページをハイライト
            bg_color = ft.colors.BLUE_100 if i == self.current_page_index else ft.colors.TRANSPARENT
    ...
    def _previous_page(self, e):
        ...
        if self.current_page_index > 0:
            ...
            self._update_pdf_display()
            self._update_page_info()
            self._update_thumbnails()  # サムネイルのハイライトを更新
...
if __name__ == "__main__":
    # Fletアプリケーションを起動
    ft.app(target=main, name="PDF個人情報マスキングツール", port=8890)