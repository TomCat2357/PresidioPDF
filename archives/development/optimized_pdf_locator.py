...
# -*- coding: utf-8 -*-
"""
最適化されたPDFTextLocator実装
rawdictベースの高精度・高速文字座標特定システム
"""
...
class OptimizedPDFTextLocator:
    ...
    def _initialize(self):
        ...
        logger.info("OptimizedPDFTextLocator初期化開始")
        ...
        try:
            ...
            logger.info(f"初期化完了: {self.stats['total_chars']}文字、{self.stats['total_pages']}ページ、{self.stats['processing_time']:.3f}秒")
...
# 互換性のためのエイリアス
PDFTextLocator = OptimizedPDFTextLocator